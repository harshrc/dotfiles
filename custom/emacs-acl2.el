...
(define-key ctl-t-keymap "\C-g" 'enter-theorem-other-window-like-sedan)

(defun enter-theorem-other-window-like-sedan ()
  (interactive)
  (push-mark)
  (point-to-register ?a)
  (let ((str (acl2-current-form-string)))
...
(define-key ctl-t-keymap "\C-b" 'enter-beg-to-curr-pos-region)
(defun enter-beg-to-curr-pos-region ()
  (interactive)
  (push-mark)
  (point-to-register ?a)
